import { z } from 'zod';
import { createIntegrationSchema, mapTerminalTransactionSchema, manualPaymentSchema } from './schemas.js';
import { getTenantIntegrations, createTenantIntegration, deleteTenantIntegration, getUnmappedMonnifyTransactions, mapTerminalTransactionToOrder, recordManualPosDevice } from './service.js';
export default async function integrationRoutes(app) {
    ...
    server.post('/orders/:orderId/map-terminal', {
        schema: {
            params: z.object({
                orderId: z.string()
            }),
    ...
    server.post('/orders/:orderId/manual-payment', {
        schema: {
            params: z.object({
                orderId: z.string()
            }),
