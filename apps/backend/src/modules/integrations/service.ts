...
import { CreateIntegrationInput, MapTerminalTransactionInput } from './schemas.js'
...
export async function createTenantIntegration(tenantId: string, data: CreateIntegrationInput) {
...
export async function deleteTenantIntegration(tenantId: string, integrationId: string) {
 ...
 */
export async function getUnmappedMonnifyTransactions(tenantId: string, integrationId?: string) {
...
export async function mapTerminalTransactionToOrder(orderId: string, data: MapTerminalTransactionInput) {
...
export async function recordManualPosDevice(orderId: string, posDeviceType: string) {
    const updatedOrder = await prisma.order.update({
        where: { id: orderId },
        data: {
            posDeviceType,
